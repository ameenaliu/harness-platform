...
| **User-branch pattern** | (constant) | `users/<user-slug>/features/<impl-slug>` (stories) and `users/<user-slug>/bugs/<impl-slug>` (bugs) — both cut off `develop`, PR base `develop`. No feature-branch tier. |
